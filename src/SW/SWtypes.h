...
/*#define sw_aligned_alloc(size, align) _aligned_malloc((align), (size))
#define sw_aligned_free _aligned_free*/
#define sw_aligned_alloc(size, align) malloc(size)
#define sw_aligned_free free
#else
#include <malloc.h>

#define sw_aligned_alloc(size, align) memalign((align), (size))
#define sw_aligned_free free
#endif
